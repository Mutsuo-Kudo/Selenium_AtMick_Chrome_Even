 ...
 * @author mukudo
 */
public class AtMickSeleniumChromeEven {

    static final Logger logger = Logger.getLogger(AtMickSeleniumChromeEven.class.getName());
    /* 時刻を格納する変数 */
    ...
    static final String filePath = "./log/AtMickSeleniumChrome_Even_" + logTimeStr1 + ".log";
...
//        driver.get("http://tetsuwangenshi.blog.so-net.ne.jp/");
        driver.get("http://blog.so-net.ne.jp/MyPage/blog/home/");
...
//            String sqlStr = "SELECT * FROM selenium_url where id > 0 order by url desc";
            String sqlStr = "SELECT * FROM selenium_url where MOD(id,3) = 2 order by url desc";
...
//                e.printStackTrace();
            ...
            JDialog dialog = pane.createDialog(null, "AtMicK_Chrome_Even");
